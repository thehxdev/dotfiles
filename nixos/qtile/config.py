...
keys = [
    ...
    Key([mod], "e", lazy.spawn("/nix/store/phmlm9svfq8swa034dial4x13nrzpiib-emacs-28.1/bin/emacsclient -c -a 'emacs'")),
...
layouts = [
    ...
    layout.MonadTall(border_focus="#ebdbb2", border_normal="#454545" , border_width=2, margin=8),
    layout.Max(),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.CurrentLayout(foreground="#fb4934", font='Ubuntu medium', fontsize=15),
                ...
                widget.WindowName(font='Ubuntu medium' ,max_chars=40, fontsize=13),
